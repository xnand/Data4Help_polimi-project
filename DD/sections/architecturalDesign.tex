...
\begin{figure}[H]
        \centering
             \includegraphics[width=1.0\textwidth]{componentInterfacesMobileClient.png}
...
\begin{figure}[H]
        \centering
             \includegraphics[width=1.0\textwidth]{componentInterfacesAppServerMobClient.png}
...
\begin{figure}[H]
        \centering
             \includegraphics[width=1.0\textwidth]{componentInterfacesAppServerD4H.png}
