...
\begin{description}
	\item Registration and login functionality for end users will make use of HTTP basic authentication. Also for this reason, all HTTP communications must make use of SSL encapsulation.
\end{description}
