...
\end{description}
% %\begin{center}
% 	\begin{tabular}{p{1.2cm}|p{3.1cm}|p{8.6cm}}
% 		\bf Version & \bf \makebox[2.1cm][c]{Release Date} & \bf \makebox[5.6cm][c]{Description} \\
% 		\hline
% 		\makebox[1.2cm][c]{1.0} & \makebox[3.1cm][c]{11/10/2018} & \makebox[5.6cm][c]{Initial Release}\\
% 		\hline
% 		\makebox[1.2cm][c]{1.1} & \makebox[3.1cm][c]{15/12/2018} & \makebox[5.6cm][c]{Fixed return arguments in sequence diagrams}\\
% 		\makebox[1.2cm][c]{} & \makebox[3.1cm][c]{} & \makebox[5.6cm][c]{Bo}\\
% 	\end{tabular}
% %\end{center}
