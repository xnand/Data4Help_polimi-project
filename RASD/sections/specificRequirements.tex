...
The mobile application was designed taking into account that users can utilize only the core functionality of the app (\textbf{Track4Help}) or all services offered (\textbf{track4Run} \& \textbf{AutomatedSOS}).\\
Opening the application, user is presented with the login page (\textit{Fig. 8.a}), if not already registered, he can sign in.\\
...
\end{figure}
The website of \textbf{Track4Help} will offer a simple form to register a company and the API documentations for developers.
